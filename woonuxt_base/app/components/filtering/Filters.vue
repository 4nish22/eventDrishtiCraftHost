...
const { data } = await useAsyncGql('getAllTerms', { taxonomies: [...taxonomies, TaxonomyEnum.PRODUCTCATEGORY, TaxonomyEnum.PRODUCTTAG] });
...
// Filter out the product tag terms
const productTagTerms = terms?.filter((term) => term.taxonomyName === 'product_tag');
...
<template>
  <aside id="filters">
    ...
    <div class="relative z-30 grid mb-12 space-y-8 divide-y">
      ...
      <TagFilter v-if="productTagTerms && productTagTerms.length" :terms="productTagTerms" />
